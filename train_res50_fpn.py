...
def main(args):
    ...
    if os.path.exists(os.path.join(VOC_root, "VOCdevkit")) is False:
        raise FileNotFoundError("data_soure dose not in path:'{}'.".format(VOC_root))

    # load train data set
    # VOCdevkit -> VOC2012 -> ImageSets -> Main -> train.txt
    train_dataset = VOCDataSet(VOC_root, data_source="federn_daunen", transforms=data_transform["train"], txt_name="train.txt")
    train_sampler = None
    ...
    val_dataset = VOCDataSet(VOC_root, data_source="federn_daunen", transforms=data_transform["val"], txt_name="val.txt")
